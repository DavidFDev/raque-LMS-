...
const LoginForm = () => {
    const { activateErrMsg, errParagraph , handleLogin } = useAuthContext()
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            {/* PASSWORD */}
            <div className="form-group">
                <input type="password" name="password" id="password" placeholder="Your password" className="form-control" value={password} onChange={e => setPassword(e.target.value)} required/>
            </div>
